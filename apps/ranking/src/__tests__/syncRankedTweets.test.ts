...
import { RankedTweet, TweetBatch, TweetData } from '../types/index';
import { getSyncRankedTweetsFn } from '../getSyncRankedTweetsFn';
...
it('should sync ranked tweet without errors', async () => {
  ...
  const syncRankedTweets = getSyncRankedTweetsFn('fakeToken');
